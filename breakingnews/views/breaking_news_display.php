...
?>
  	...
  	if(get_post_meta( get_the_ID(), 'bn_custom_title', true) ): ?>
  		<h2><span><?php echo $breaking_news_area_title; ?> : </span><a href='<?php echo get_post_permalink(); ?>'> <?php echo get_post_meta( get_the_ID(), 'bn_custom_title', true); ?> </a></h2>
  	<?php else: ?>
  		<h2><span><?php echo $breaking_news_area_title; ?> : </span><a href='<?php echo get_post_permalink(); ?>'> <?php echo get_the_title(); ?> </a></h2>
  	<?php endif; ?>
